import {
    ...
    TemplateRef,
    ViewContainerRef,
    Injector, ContentChild, AfterViewInit, ContentChildren, QueryList, ViewChildren, AfterViewChecked
} from '@angular/core';
...
export class TimelineComponent extends TRAISI.SurveyQuestion<TRAISI.ResponseTypes.Timeline> implements OnInit, AfterViewInit, AfterViewChecked {
    typeName: string;
    icon: string;
    modalRef: BsModalRef;
    icons: {} = {
    ...
    @ViewChild(TemplateRef,{read: ViewContainerRef}) inputTemplate: ViewContainerRef;
