...
export class SurveyManager {
    ...
    constructor() {
        ...
        surveyManagerModule.controller("SurveyManagerController", ['$scope', '$rootScope', '$http', '$window', '$mdSidenav', '$location', '$translate',
            'SurveyConfigService', SurveyManagerController])
