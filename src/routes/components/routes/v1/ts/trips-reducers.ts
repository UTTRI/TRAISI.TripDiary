...
import {
    ...
    OPTION_TRIPS_TAKEN, REMOVE_MODE_SWITCH,
    REMOVE_TRIP_LEG,
    REMOVE_TRIP_LOCATION,
    SET_MODE_SWITCH_DATA,
    SET_ROUTE_EDIT_ACTIVE,
    SET_ROUTE_EDIT_COMPLETE, SET_ROUTE_EDIT_INCOMPLETE,
    SET_SWITCH_ROUTE_MODE_STATE,
    SET_TRIP_LEG_ACTIVE,
    SET_TRIP_LEG_DATA, SET_TRIP_LEG_EDIT_COMPLETE, SET_TRIP_LEG_INCOMPLETE, SET_TRIP_LEG_WAYPOINTS,
    SET_TRIP_MODE,
    SET_UNKNOWN_ROUTE,
...
export function tripsState(state = INITIAL_STATE, action) {
    ...
    switch (action.type) {
        ...
        case REMOVE_TRIP_LOCATION:
            ...
            for (var i = 0; i < newState.tripLocations.length; i++) {
        ...
        case SET_TRIP_MODE:
            ...
            if (!action.payload.usesWaypoints) {
                ...
                let w2 = _.last(activeTripLeg._waypoints);
        ...
        case SET_TRIP_LEG_EDIT_COMPLETE:
            ...
            for (let leg of activeTripRoute.tripLegs) {
        ...
        case REMOVE_MODE_SWITCH:
            ...
            if (activeTripRoute.tripLegs.length == 1) {
                ...
                let startWaypoint = _.clone(activeTripLeg._waypoints[0]);
                let endWaypoint = _.clone(_.last(toRemove._waypoints));
        ...
        case SET_MODE_SWITCH_DATA:
            ...
            leg.waypoints.push(_.clone(switchLocation));

            //end point is the end
            leg.waypoints.push(_.clone(_.last(activeTripLeg._waypoints)));

            //active trip location is  the switch location

            let start = _.clone(activeTripLeg._waypoints[0]);
            activeTripLeg._waypoints = [];
            activeTripLeg._waypoints.push(start);
            activeTripLeg._waypoints.push(_.clone(switchLocation));
            activeTripLeg._coordinates = [];
        ...
        case SET_UNKNOWN_ROUTE:
            ...
            //activeTripLeg._isComplete = true;
            activeTripLeg._coordinates = [];
            activeTripLeg._coordinates[0] = _.first(activeTripLeg._waypoints);
            activeTripLeg._coordinates[1] = _.last(activeTripLeg._waypoints);
