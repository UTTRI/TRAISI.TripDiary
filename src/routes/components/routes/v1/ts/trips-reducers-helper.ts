...
export class TripsReducersHelper {
    ...
    static sortTripLocations(tripLocations: TripLocation[]) {
        ...
        for (var i = 0; i < tripLocations.length; i++) {
            for (var j = 0; j < tripLocations.length - 1; j++) {
                /* compare start time */
    ...
    static hydrateTripLocation(tripLocation: TripLocation): TripLocation {
        ...
        var p2: TripLocation = Object.create(TripLocation.prototype);
        //var p2 = new TripLocation();

        /* convert time from object */
        var endTime = tripLocation._endTime;
        var startTime = tripLocation._startTime;
    ...
    static hydrateTripRoute(tripRoute: TripRoute): TripRoute {
        ...
        var p2: TripRoute = Object.create(TripRoute.prototype);
